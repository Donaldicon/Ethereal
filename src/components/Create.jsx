...
const Create = () => {
  return (
    <div
      className="flex flex-col md:flex-row items-center justify-center bg-[#FAFBFB] pb-8 md:pb-0 mt-10"
      id="waitlist"
    >
      ...
      <div className="hidden md:block overflow-hidden">
        ...
        >
          <div className="pl-0 md:-pl-50 xl:-pl-[205px] flex justify-center items-center md:items-start flex-col ">
            ...
            <p className="text-[#808080] text-[10px] md:text-[14px] lg:text-[16px] xl:text-[18px] font-poppins mt-2 leading-[25px]">
              Join thousands of others getting early access to Ethereal.
            </p>
      ...
      <div className="block md:hidden overflow-hidden -mt-7">
        ...
        >
          <div className="pl-0 flex justify-center items-center md:items-start flex-col ">
            ...
            <p className="text-[#0FA875] font-bold font-voltaire text-[48px] leading-[60px]">
              One App.
            </p>

            <p className="text-[#363636] text-[48px] font-barlow font-semibold  leading-[60px]">
              Less Stress.
            </p>

            <p className="text-[#808080] text-[15px] text-center font-poppins mt-2 leading-[25px]">
              Join thousands of others getting
              <br /> early access to Ethereal.
            </p>
