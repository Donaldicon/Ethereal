    ...
    <div>
        ...
        <div className='relative hidden md:flex flex-col justify-center bg-[#FAFBFB]'>
            ...
            <div className='absolute left-[7%] top-[2%]'>
                <img src={horizontalLine} alt="" className='h-[600px] lg:h-[750px] desktop:h-[1000px] bigScreens:h-[1200px]'/>
            </div>
            ...
            >
                <div className='flex flex-col items-center justify-center pt-[4%] pb-[4%]'>
                    <p className='text-center font-bold font-barlow text-[37px] lg:text-[45px] text-[#363636] leading-[45px] lg:leading-[50px] xl:leading-[65px] xl:text-[55px]'>Find & Book Hotels Near You <br /> in real- time instantly with <span className='text-[#259F72] font-voltaire'>Ethereal</span></p>
                    <p className='text-center font-poppins text-[#808080] text-opacity-80 mt-3 mb-7 text-[14px] lg:text-[16px] xl:text-[18px]'>Whether you're new in town or just need a quick stay nearby, Ethereal <br /> shows you every hotel around you, in real-time.</p>
        ...
        <div className='relative md:hidden flex flex-col justify-center bg-[#FAFBFB] mt-[40px]'>
            ...
            >
                <div className='flex flex-col items-center justify-center pt-[3%] pb-[4%]'>
                    <p className='text-center font-bold font-barlow text-[25px] text-[#363636] leading-[33px]'>Find & Book Hotels Near <br />  You in real- time instantly <br /> with <span className='text-[#259F72] font-voltaire'>Ethereal</span></p>
                    <p className='text-center font-poppins text-[#808080] text-opacity-80 mt-1 mb-4 text-[10px]'>Whether you're new in town or just need a<br /> quick stay nearby, Ethereal shows you<br /> every hotel around you, in real-time.</p>
