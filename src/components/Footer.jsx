...
const Footer = () => {
  ...
  return (
    <section>
      <div className="mt-10 bg-[#000000] text-white font-poppins px-[2%] py-[3%] rounded-3xl overflow-visible hidden md:block">
        <div className="flex items-center justify-between w-full">
          <div className="flex flex-col w-[50%]">
            ...
            <p className="font-barlow mt-3 text-white md:text-[11px] lg:text-[13px] xl:text-[15px] ">
              Copyright © {currentYear} Ethereal. All rights reserved.
            </p>
          </div>

          <div className="space-y-[30%] text-white md:text-[13px] lg:text-[15px] xl:text-[18px] flex flex-col items-end">
        ...
        <div className="mt-2 md:text-[11px] lg:text-[13px] xl:text-[15px] text-white font-barlow flex items-center justify-center space-x-4">
      ...
      {/* Mobile View */}
      <div className="mt-10 bg-[#000000] text-white font-poppins py-5 rounded-3xl block md:hidden px-[5%]">
        <div className="flex flex-col w-full">
          <div className="flex flex-col">
            ...
            <p className="font-barlow mt-1 text-white text-[11px]  ">
              Copyright © {currentYear} Ethereal. All rights reserved.
            </p>
          </div>

          <div className="space-y-5 mt-7 text-white text-[15px]  flex flex-col items-start">
            <div className="overflow-hidden">
              <motion.div
                initial={{ x: 20, opacity: 0 }}
                whileInView={{ x: 0, opacity: 1 }}
        ...
        <div className="mt-2 text-[11px]  text-white font-barlow flex items-center justify-center space-x-4">
          <p>Terms&Conditions</p>
          <p>Privacy Policy</p>
        </div>
      </div>
